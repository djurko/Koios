...
{
    public class KoiosContext : DbContext
    {
        public KoiosContext() : base()
        {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=koios;Integrated Security=True;MultipleActiveResultSets=True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            var countries = new Country[]
            {
                ...
                new Country() {CountryId = 29, Name = "Côte d'Ivoire"},
                ...
                new Country() {CountryId = 40, Name = "Congo"},
                ...
                new Country() {CountryId = 45, Name = "Czech Republic"},
                ...
                new Country() {CountryId = 119, Name = "Myanmar"},
            ...
            {
                new Settlement() { SettlementId = 1, Name = "Settlement1", ZipCode = "Zip1", CountryId = 1 },
                new Settlement() { SettlementId = 2, Name = "Settlement2", ZipCode = "Zip2", CountryId = 2 },
                new Settlement() { SettlementId = 3, Name = "Settlement3", ZipCode = "Zip3", CountryId = 42 }
            };
